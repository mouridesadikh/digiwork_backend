...
<div class="owl-carousel-wrapper">
    ...
    <div class="owl-carousel owl-1 ">
      <div class="ftco-cover-1 overlay" style="background-image: url('{{ asset('/home_css/images/hero_1.jpg')}}');"></div>
      <div class="ftco-cover-1 overlay" style="background-image: url('{{ asset('/home_css/images/hero_2.jpg')}}');"></div>
      <div class="ftco-cover-1 overlay" style="background-image: url('{{ asset('/home_css/images/hero_3.jpg')}}');"></div>
  ...
  <div class="container">
    <div class="feature-29192-wrap d-md-flex" style="margin-top: -20px; position: relative; z-index: 2;">
      ...
      <a href="#" class="feature-29192 overlay-danger" style="background-image: url('{{ asset('/home_css/images/img_3_gray.jpg')}}');">
        <div class="text">
      ...
      <a class="feature-29192 overlay-success" style="background-image: url('{{ asset('/home_css/images/img_2_gray.jpg')}}');">
        <div class="text">
      ...
      <div class="feature-29192 overlay-warning" style="background-image: url('{{ asset('/home_css/images/img_1_gray.jpg')}}');">
        <div class="text">
      ...
      <div class="row mb-5 align-items-st">
        <div class="col-md-4">
          <div class="heading-20219">
            <h2 class="title text-cursive">Latest Annonce</h2>
          </div>
        </div>
        <div class="col-md-8">
      ...
      <div class="row">
        <div class="col-md-4">
            <div class="cause shadow-sm">
              ...
              <a href="#" class="cause-link d-block">
                <img src="{{ asset('/home_css/images/img_1.jpg')}}" alt="Image" class="img-fluid">
              ...
              <div class="px-3 pt-3 border-top-0 border border shadow-sm">
                ...
                <div class="py-4">
                  <div class="d-flex align-items-center">
                    <img src="{{ asset('/home_css/images/person_1.jpg')}}" alt="Image" class="rounded-circle mr-3" width="50">
        ...
        <div class="col-md-4">
          ...
          <div class="cause shadow-sm">
              ...
              <a href="#" class="cause-link d-block">
                <img src="{{ asset('/home_css/images/img_2.jpg')}}" alt="Image" class="img-fluid">
                <div class="custom-progress-wrap">
                  <span class="caption">80% complete</span>
                  <div class="custom-progress-inner">
        ...
        <div class="col-md-4">
          ...
          <div class="cause shadow-sm">
              ...
              <a href="#" class="cause-link d-block">
                <img src="{{ asset('/home_css/images/img_3.jpg')}}" alt="Image" class="img-fluid">
                <div class="custom-progress-wrap">
                  <span class="caption">80% complete</span>
                  <div class="custom-progress-inner">
  ...
  <div class="bg-image overlay site-section" style="background-image: url('{{ asset('/home_css/images/hero_1.jpg') }} ');">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="event-29191 mb-5">
            <a href="#" class="d-block mb-3"><img src="{{ asset('/home_css/images/img_1.jpg')}}" alt="Image" class="img-fluid rounded"></a>
        ...
        <div class="col-md-6">
          <div class="event-29191 mb-5">
            <a href="#" class="d-block mb-3"><img src="{{ asset('/home_css/images/img_2.jpg')}}" alt="Image" class="img-fluid rounded"></a>
            <div class="px-3 d-flex">
  ...
  <div class="site-section bg-image overlay-primary" style="background-image: url('images/img_1.jpg');">
    <div class="container">
      <div class="row align-items-stretch">
        <div class="col-md-6">
          <img src="{{ asset('/home_css/images/img_1.jpg')}}" alt="Image" class="img-fluid shadow">
        </div>
        <div class="col-md-6">
